...
export default function TabsLayout() {
  return (
    <Tabs screenOptions={{ tabBarActiveTintColor: '#ef4444' }}>
      ...
      <Tabs.Screen name="safe-zones" options={{ title: 'Safe Zones', tabBarIcon: ({ color, size }) => <Ionicons name="shield-checkmark" size={size} color={color} /> }} />
      <Tabs.Screen name="emergency-contacts" options={{ title: 'Contacts', tabBarIcon: ({ color, size }) => <Ionicons name="people" size={size} color={color} /> }} />
